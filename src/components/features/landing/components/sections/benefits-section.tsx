        ...
        <div className="hidden md:block mt-20 pt-16 border-t border-gray-200">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-10 border border-origen-hoja/30 shadow-origen">
              ...
              <div className="mt-8 pt-8 border-t border-origen-hoja/20 flex items-center justify-center gap-2 text-base text-origen-bosque/80">
                <CheckCircle className="w-5 h-5 text-origen-hoja" />
