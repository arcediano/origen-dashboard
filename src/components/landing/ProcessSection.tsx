  ...
  const StepCard = ({ step, index }: { step: typeof steps[0]; index: number }) => {
    ...
    return (
      <div className="group relative h-full">
        <div className="bg-white rounded-2xl p-5 md:p-8 shadow-lg md:shadow-xl border border-gray-200 hover:border-origen-pradera hover:shadow-2xl transition-all duration-300 h-full">
          <div className="relative mb-4 md:mb-6">
            ...
            <div className={`w-14 h-14 md:w-20 md:h-20 rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-6 ${step.color}`}>
              <Icon className={`w-7 h-7 md:w-10 md:h-10 ${step.iconColor}`} />
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-1.5 text-xs md:text-sm font-medium px-3 py-1.5 rounded-full bg-origen-crema border border-origen-pradera/30">
              {index === 0 ? (
                <>
