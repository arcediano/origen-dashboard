        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8 md:mb-12 max-w-3xl mx-auto">
            {[
              ...
              { value: '98%', label: 'Satisfacción', accent: 'border-l-green-400' },
              { value: 'ES/EN', label: 'Idiomas soporte', accent: 'border-l-origen-pradera' },
              { value: '5★', label: 'Valoración', accent: 'border-l-amber-400' },
            ].map(({ value, label, accent }) => (
              <div key={value} className={`bg-white rounded-xl p-4 text-center border border-gray-100 border-l-4 ${accent} shadow-subtle`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
            {[
              ...
              <div key={title} className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-6 md:p-7 border border-gray-200 shadow-origen group-hover:shadow-origen-lg group-hover:border-origen-hoja/40 transition-all duration-300 text-center">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-origen-bosque to-origen-pino flex items-center justify-center mb-4 mx-auto shadow-subtle">
                  ...
                  {badge && (
                    <div className="mt-3">
                      <span className="text-xs bg-origen-bosque text-white px-3 py-1 rounded-full font-medium">{badge}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="text-center">
            <div className="bg-white rounded-2xl p-6 md:p-7 max-w-2xl mx-auto mb-6 border border-origen-pradera/20 shadow-subtle">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Button size="lg" variant="outline" className="border-origen-bosque/50 text-origen-bosque hover:bg-origen-pastel hover:border-origen-bosque px-6 py-3 text-sm md:text-base">
                  Ver preguntas frecuentes
                </Button>
                <Button size="lg" className="bg-origen-bosque hover:bg-origen-pino text-white px-6 py-3 text-sm md:text-base">
