    ...
    <section className="py-10 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-7 md:mb-16">
          <div className="inline-flex items-center gap-2 bg-origen-pradera/10 text-origen-bosque rounded-full px-4 py-2 mb-3 md:mb-6 border border-origen-pradera/30">
