        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Acceda a la sección "Mis Productos" y haga clic en "Crear Producto". Siga las instrucciones paso a paso.</p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900">¿Qué tipos de productos puedo vender?</h3>
              <p className="text-gray-600 mt-1">Solo productos agrícolas y artesanales producidos localmente pueden ser vendidos en la plataforma.</p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900">¿Cómo proceso un pedido?</h3>
              <p className="text-gray-600 mt-1">Ingrese a la sección "Pedidos" y utilice las herramientas disponibles para gestionar y procesar los pedidos recibidos.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm mt-1">Guías detalladas sobre todas las funcionalidades de la plataforma.</p>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm mt-1">Vídeos explicativos paso a paso para cada función.</p>
              <button className="mt-2 text-sm text-origen-pradera hover:text-origen-bosque font-medium">
                Ver tutoriales
              </button>
            </div>
