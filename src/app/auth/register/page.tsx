...
import { SimpleRegistration } from '@/components/landing/SimpleRegistration';
...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-origen-crema/30">
      ...
      <footer className="bg-origen-bosque">
        <div className="container mx-auto px-4 md:px-6 pt-10 pb-6 md:pt-14 md:pb-8">
          ...
          <div className="md:hidden">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/auth/login" className="text-xs font-medium text-origen-menta hover:text-white transition-colors flex items-center gap-1">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="pt-2">
                    <Link href="/auth/login" className="text-sm font-medium text-origen-menta hover:text-white transition-colors inline-flex items-center gap-1">
            ...
            <div className="mt-10 pt-6 border-t border-white/10">
              <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                ...
                <p className="text-xs text-white/70">Versión 2.0.3 • Registro de productores</p>
              </div>
