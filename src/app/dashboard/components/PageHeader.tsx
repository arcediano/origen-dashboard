...
export function PageHeader({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className={cn('relative container mx-auto px-4 sm:px-6 py-8 sm:py-10', containerClassName)}>
        {/* Fila superior con badge y acciones */}
        ...
        {/* Fila principal con título y botón de volver */}
