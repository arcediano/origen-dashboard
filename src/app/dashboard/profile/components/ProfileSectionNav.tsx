      ...
      {PROFILE_NAV_ITEMS.map((item) => {
        ...
        return (
          <Link
            ...
            href={item.href}
            className={cn(
              'rounded-xl border px-2.5 py-2 text-center text-[12px] leading-tight font-semibold transition-colors flex items-center justify-center min-h-[44px] sm:px-3 sm:text-sm',
              isActive
