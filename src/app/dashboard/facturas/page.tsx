 ...
 *
 * Solo facturas de venta (las que genera cada compra de un cliente) — las
 * facturas de comisión mensual de Origen viven en /dashboard/account/facturacion
 * (decisión del humano, 2026-09-09: separar los dos accesos que antes
 * convivían aquí como pestañas "Ventas"/"Comisión").
 *
    ...
    <MobilePullRefresh onRefresh={handleRefresh}>
      <>
        ...
        <PageHeader
          ...
          tooltipDetailed="La factura de cada pedido de un solo vendedor (los pedidos con productos de varios productores no generan factura individual). La factura mensual de comisión de Origen está en Cuenta → Facturación."
        />
