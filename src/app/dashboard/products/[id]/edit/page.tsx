...
export default function EditProductPage() {
  ...
  return (
    <div className="w-full">
        ...
        {formData.status === 'draft' && !allStepsCompleted && (() => {
          ...
          return (
            <Alert variant="warning" className="mt-4">
              <AlertTitle>Borrador — este producto no se puede publicar todavía</AlertTitle>
              <AlertDescription>
                Pasos pendientes: <span className="font-medium">{pendingSteps.join(', ')}</span>.
      ...
      <SensitiveChangeConfirmDialog
        open={pendingSensitiveConfirmation}
        sensitiveDirtyFields={sensitiveDirtyFields}
        onConfirm={confirmSensitiveSave}
        onCancel={() => {
