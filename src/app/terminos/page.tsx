  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="prose max-w-none">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">1. Aceptación de los Términos</h2>
        <p className="text-foreground mb-4">
          Al acceder o utilizar nuestra plataforma, acepta quedar vinculado por estos Términos y Condiciones.
        </p>

        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">2. Uso de la Plataforma</h2>
        <p className="text-foreground mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">3. Responsabilidades del Usuario</h2>
        <p className="text-foreground mb-4">
          Como usuario, debe:
        </p>
        <ul className="list-disc pl-6 text-foreground mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">5. Limitación de Responsabilidad</h2>
        <p className="text-foreground mb-4">
          La plataforma se proporciona "tal cual". No garantizamos que esté libre de errores ni que cumpla con sus expectativas.
        </p>

        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">6. Modificaciones de los Términos</h2>
        <p className="text-foreground mb-4">
